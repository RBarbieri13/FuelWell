...
enum QualityIdentifier {
    ...
    static let accountPlan = "account.plan"
    static let accountControls = "account.controls"
    static let accountSignOut = "account.sign-out"
    static let accountDelete = "account.delete"
    static let accountMessage = "account.message"
