...
Continue W6 by replacing remaining static Menu/help/profile affordances with real destinations, closing deferred Learn/help decisions, and trailing quality tests behind each surface.
