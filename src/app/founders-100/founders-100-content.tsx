...
type Founders100ContentProps = {
  spotsClaimed: number;
};

export function Founders100Content({ spotsClaimed }: Founders100ContentProps) {
  const spotsRemaining = Math.max(0, 100 - spotsClaimed);
  ...
  return (
    <>
            ...
            <div className="mt-10 inline-flex items-center gap-5 rounded-2xl border-2 border-violet-200 bg-white shadow-lg backdrop-blur-sm px-10 py-6 glow-premium">
              ...
              <div className="text-left">
                <span className="text-4xl font-bold tabular-nums text-foreground">
                  <CountUp end={spotsClaimed} duration={1200} suffix="/100" />
                </span>
              ...
              <div className="hidden sm:block text-left">
                <p className="text-2xl font-bold text-fw-premium">{spotsRemaining}</p>
      ...
      <Section id="pricing" className="bg-fw-surface">
        ...
        {/* Primary CTA under pricing — no payment required today */}
        <AnimatedSection delay={0.3} className="mt-10 text-center">
          <GradientButton href="/signup?from=founders-100" size="lg">
            Claim Your Founders 100 Spot
            <ArrowRight className="ml-2 h-5 w-5" />
          </GradientButton>
          <p className="mt-3 text-xs text-muted-foreground">
            No payment required today — we&apos;re just collecting Founders 100 members.
          </p>
        </AnimatedSection>
      ...
      <Section>
        <AnimatedSection className="text-center max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-2 rounded-full border-2 border-fw-orange/30 bg-fw-orange/5 px-5 py-2 text-sm text-fw-orange font-semibold mb-6 shadow-sm">
            ...
            Limited availability — {spotsRemaining} spots remaining
          </div>
