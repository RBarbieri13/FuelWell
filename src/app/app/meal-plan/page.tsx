                    ...
                    >
                      ...
                      <div className="mt-4 grid grid-cols-2 gap-2">
                        <div className="rounded-[1rem] bg-white px-4 py-3">
                          <p className="text-[11px] font-black uppercase tracking-[0.12em] text-muted-foreground">Calories</p>
                          <p className="text-xl font-black tabular-nums text-[#16302a]">
                            {totals.calories.toLocaleString()}
                          </p>
                        </div>
                        <div className="rounded-[1rem] bg-white px-4 py-3">
                          <p className="text-[11px] font-black uppercase tracking-[0.12em] text-muted-foreground">Protein</p>
                          <p className="text-xl font-black tabular-nums text-[#16302a]">
                            {totals.protein}g
                          </p>
                        </div>
