  ...
  return (
    <div className="fw-app-surface min-h-full">
      ...
      <div className="fw-page-inner max-w-[1120px] space-y-4 pb-28 md:space-y-6 md:pb-8">
        ...
        {/* One next step */}
        <Skeleton className="h-28 rounded-[24px] bg-[#123d32]/85" />

        {/* Chart card: header, series chips, bars, axis strip */}
        <div className="rounded-[24px] border border-hairline bg-surface p-5 shadow-e2 md:p-6">
          ...
          <div className="mt-5 flex h-[172px] items-end gap-2 border-b border-hairline pb-4">
            {[
              "h-[62%]",
              "h-[84%]",
              "h-[71%]",
              ...
              <Skeleton
                key={index}
                className={`min-w-0 flex-1 rounded-t-[0.6rem] bg-surface-sunken ${height}`}
              />
            ))}
          </div>
        ...
        <Skeleton className="h-56 rounded-[24px] bg-surface/85" />
