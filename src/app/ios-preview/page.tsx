...
// 44px targets and a single focus treatment shared by all three CTAs.
const previewCta =
  "inline-flex min-h-11 items-center gap-2 rounded-2xl px-5 text-sm font-black transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-300 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950";
